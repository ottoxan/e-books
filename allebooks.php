...
<section id="ebooks-section" class="d-flex py-0 flex-column pt-5">
    <div class="container">
        <div class="section-header">
            ...
            <p>A book is information containing writing or images, used to convey knowledge, stories, or ideas. Books can be in print or digital form, and play an important role in education, entertainment, and self-development.</p>
        </div>
